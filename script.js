...
function showV2MicPermission(type, btn) {
    // 1. Ensure we are on V2 dialing screen in connecting state
    startV2CallConnection(btn);
    ...
    // 3. Show the requested V2 modal
    let modalId = '';
    if (type === 'ios-chrome') modalId = 'modal-v2-ios-chrome';
    else if (type === 'android') modalId = 'modal-v2-android';
    else if (type === 'ios-safari') modalId = 'modal-v2-ios-safari';
